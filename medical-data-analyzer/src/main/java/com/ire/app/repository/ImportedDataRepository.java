...
public interface ImportedDataRepository extends CrudRepository<ImportedDataModel, Integer> {
    ...
    List<ImportedDataModel> getAllByImportStatusAndConvertedByPCA(String importStatus, boolean isConv);

    List<ImportedDataModel> getAllByImportStatusAndConvertedByTSNE(String importStatus, boolean isConv);

    List<ImportedDataModel> getAllByImportStatusAndConvertedByLLE(String importStatus, boolean isConv);
